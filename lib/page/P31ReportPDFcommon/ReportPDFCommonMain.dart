  ...
  Widget build(BuildContext context) {
    ...
    if (_dataCOMMON.datain.isNotEmpty) {
      ...
      for (var i = 0; i < _dataCOMMON.datain.length; i++) {
        ...
        //Compound Layer
        // if (_dataCOMMON.datain[i].datapackset.length > 1) {
        if (_dataCOMMON.datain[i].ITEMname.contains('Coating') ||
            _dataCOMMON.datain[i].ITEMname.contains('coating')) {
        ...
        } else if (_dataCOMMON.datain[i].ITEMname.contains('-')) {
          SCT = _dataCOMMON.datain[i].ITEMname;
                                                  ...
                                                  child: Column(
                                                    children: const [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          "(ใบรายงานผลการตรวจสอบผลิตภัณฑ์สำหรับกระบวนการ PVD Coating)",
                                                          style: TextStyle(
                                                            fontSize: 16,
                                                          ),
                                                        ),
