...
abstract class MAXMIN_Event {}

class MAXMIN_READ extends MAXMIN_Event {}

class MAXMIN_Bloc extends Bloc<MAXMIN_Event, MAXMINSCHEMA> {
  MAXMIN_Bloc()
      : super(MAXMINSCHEMA(
          ItemPick: [''],
  ...
  Future<void> _MAXMIN_READ(
      MAXMINSCHEMA toAdd, Emitter<MAXMINSCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "MAXMINdb",
      data: {},
    );
    MAXMINSCHEMA output = MAXMINSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
