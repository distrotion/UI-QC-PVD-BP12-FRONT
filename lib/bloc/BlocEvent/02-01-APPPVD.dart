...
abstract class APPPVD_Event {}

class APPPVD_READ extends APPPVD_Event {}

class APPPVD_Bloc extends Bloc<APPPVD_Event, APPPVDSCHEMA> {
  APPPVD_Bloc()
      : super(APPPVDSCHEMA(
          ItemPick: [''],
  ...
  Future<void> _APPPVD_READ(
      APPPVDSCHEMA toAdd, Emitter<APPPVDSCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "APPPVDdb",
      data: {},
    );
    APPPVDSCHEMA output = APPPVDSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
