...
abstract class GASOHR001_Event {}

class GASOHR001_READ extends GASOHR001_Event {}

class GASOHR001_Bloc extends Bloc<GASOHR001_Event, GASOHR001SCHEMA> {
  GASOHR001_Bloc()
      : super(GASOHR001SCHEMA(
          ItemPick: [''],
    ...
    on<GASOHR001_READ>((event, emit) {
      return _GASOHR001_READ(
          GASOHR001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASOHR001_READ(
      GASOHR001SCHEMA toAdd, Emitter<GASOHR001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASOHR001db",
      data: {},
    );
    GASOHR001SCHEMA output = GASOHR001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
