...
abstract class SPLINEGAUGE_Event {}

class SPLINEGAUGE_READ extends SPLINEGAUGE_Event {}

class SPLINEGAUGE_Bloc extends Bloc<SPLINEGAUGE_Event, SPLINEGAUGESCHEMA> {
  SPLINEGAUGE_Bloc()
      : super(SPLINEGAUGESCHEMA(
          ItemPick: [''],
    ...
    on<SPLINEGAUGE_READ>((event, emit) {
      return _SPLINEGAUGE_READ(
          SPLINEGAUGESCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _SPLINEGAUGE_READ(
      SPLINEGAUGESCHEMA toAdd, Emitter<SPLINEGAUGESCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "SPLINEGAUGEdb",
      data: {},
    );
    SPLINEGAUGESCHEMA output = SPLINEGAUGESCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
