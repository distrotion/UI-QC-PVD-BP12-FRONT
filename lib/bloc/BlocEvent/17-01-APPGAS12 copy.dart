...
abstract class BLOCKGAUGE_Event {}

class BLOCKGAUGE_READ extends BLOCKGAUGE_Event {}

class BLOCKGAUGE_Bloc extends Bloc<BLOCKGAUGE_Event, BLOCKGAUGESCHEMA> {
  BLOCKGAUGE_Bloc()
      : super(BLOCKGAUGESCHEMA(
          ItemPick: [''],
    ...
    on<BLOCKGAUGE_READ>((event, emit) {
      return _BLOCKGAUGE_READ(
          BLOCKGAUGESCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _BLOCKGAUGE_READ(
      BLOCKGAUGESCHEMA toAdd, Emitter<BLOCKGAUGESCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "BLOCKGAUGEdb",
      data: {},
    );
    BLOCKGAUGESCHEMA output = BLOCKGAUGESCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
