...
abstract class PVDMCS001_Event {}

class PVDMCS001_READ extends PVDMCS001_Event {}

class PVDMCS001_Bloc extends Bloc<PVDMCS001_Event, PVDMCS001SCHEMA> {
  PVDMCS001_Bloc()
      : super(PVDMCS001SCHEMA(
          ItemPick: [''],
    ...
    on<PVDMCS001_READ>((event, emit) {
      return _PVDMCS001_READ(
          PVDMCS001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _PVDMCS001_READ(
      PVDMCS001SCHEMA toAdd, Emitter<PVDMCS001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "PVDMCS001db",
      data: {},
    );
    PVDMCS001SCHEMA output = PVDMCS001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
