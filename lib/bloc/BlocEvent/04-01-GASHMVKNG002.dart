...
abstract class GASHMVPVD002_Event {}

class GASHMVPVD002_READ extends GASHMVPVD002_Event {}

class GASHMVPVD002_Bloc extends Bloc<GASHMVPVD002_Event, GASHMVPVD002SCHEMA> {
  GASHMVPVD002_Bloc()
      : super(GASHMVPVD002SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMVPVD002_READ>((event, emit) {
      return _GASHMVPVD002_READ(
          GASHMVPVD002SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMVPVD002_READ(
      GASHMVPVD002SCHEMA toAdd, Emitter<GASHMVPVD002SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMVPVD002db",
      data: {},
    );
    GASHMVPVD002SCHEMA output = GASHMVPVD002SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
