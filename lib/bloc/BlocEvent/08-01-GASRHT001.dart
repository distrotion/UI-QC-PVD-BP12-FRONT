...
abstract class CTCXTM001_Event {}

class CTCXTM001_READ extends CTCXTM001_Event {}

class CTCXTM001_Bloc extends Bloc<CTCXTM001_Event, CTCXTM001SCHEMA> {
  CTCXTM001_Bloc()
      : super(CTCXTM001SCHEMA(
          ItemPick: [''],
    ...
    on<CTCXTM001_READ>((event, emit) {
      return _CTCXTM001_READ(
          CTCXTM001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _CTCXTM001_READ(
      CTCXTM001SCHEMA toAdd, Emitter<CTCXTM001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "CTCXTM001db",
      data: {},
    );
    CTCXTM001SCHEMA output = CTCXTM001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
