...
abstract class PVDSCT001_Event {}

class PVDSCT001_READ extends PVDSCT001_Event {}

class PVDSCT001_Bloc extends Bloc<PVDSCT001_Event, PVDSCT001SCHEMA> {
  PVDSCT001_Bloc()
      : super(PVDSCT001SCHEMA(
          ItemPick: [''],
    ...
    on<PVDSCT001_READ>((event, emit) {
      return _PVDSCT001_READ(
          PVDSCT001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _PVDSCT001_READ(
      PVDSCT001SCHEMA toAdd, Emitter<PVDSCT001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "PVDSCT001db",
      data: {},
    );
    PVDSCT001SCHEMA output = PVDSCT001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
