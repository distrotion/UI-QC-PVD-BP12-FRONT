...
abstract class CALO001_Event {}

class CALO001_READ extends CALO001_Event {}

class CALO001_Bloc extends Bloc<CALO001_Event, CALO001SCHEMA> {
  CALO001_Bloc()
      : super(CALO001SCHEMA(
          ItemPick: [''],
    ...
    on<CALO001_READ>((event, emit) {
      return _CALO001_READ(
          CALO001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _CALO001_READ(
      CALO001SCHEMA toAdd, Emitter<CALO001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "CALO001db",
      data: {},
    );
    CALO001SCHEMA output = CALO001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
