...
abstract class GASHMVPVD001_Event {}

class GASHMVPVD001_READ extends GASHMVPVD001_Event {}

class GASHMVPVD001_Bloc extends Bloc<GASHMVPVD001_Event, GASHMVPVD001SCHEMA> {
  GASHMVPVD001_Bloc()
      : super(GASHMVPVD001SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMVPVD001_READ>((event, emit) {
      return _GASHMVPVD001_READ(
          GASHMVPVD001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMVPVD001_READ(
      GASHMVPVD001SCHEMA toAdd, Emitter<GASHMVPVD001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMVPVD001db",
      data: {},
    );
    GASHMVPVD001SCHEMA output = GASHMVPVD001SCHEMA(
      Pic: "",
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
