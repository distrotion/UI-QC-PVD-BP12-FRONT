...
abstract class GASHMVPVD003_Event {}

class GASHMVPVD003_READ extends GASHMVPVD003_Event {}

class GASHMVPVD003_Bloc extends Bloc<GASHMVPVD003_Event, GASHMVPVD003SCHEMA> {
  GASHMVPVD003_Bloc()
      : super(GASHMVPVD003SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMVPVD003_READ>((event, emit) {
      return _GASHMVPVD003_READ(
          GASHMVPVD003SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMVPVD003_READ(
      GASHMVPVD003SCHEMA toAdd, Emitter<GASHMVPVD003SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMVPVD003db",
      data: {},
    );
    GASHMVPVD003SCHEMA output = GASHMVPVD003SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
